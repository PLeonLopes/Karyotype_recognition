...
if pares_selecionados:
    ...
    altura_par = 60  # Aumentei a altura para melhor visualização
    largura_par = 120  # Aumentei a largura para melhor visualização
    ...
    for linha in range(num_linhas):
        for coluna in range(num_colunas):
            if indice_par < num_pares:
                ...
                # Extrai os cromossomos das imagens originais usando as máscaras
                cromossomo1 = cv2.bitwise_and(imagem, imagem, mask=mascara1)
                cromossomo2 = cv2.bitwise_and(imagem, imagem, mask=mascara2)

                # Converte para fundo branco com cromossomos pretos
                cromossomo1[cromossomo1 != 0] = 0  # Deixa os cromossomos pretos
                cromossomo2[cromossomo2 != 0] = 0  # Deixa os cromossomos pretos
    ...
    # Exibe a imagem final com os pares
